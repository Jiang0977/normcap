...
- [Download for **Windows**](https://github.com/dynobo/normcap/releases/download/v0.6.1/NormCap-0.6.1-x86_64-Windows.msi)
  <small>Installer, x86_64, ~120 MB</small>
- [Download for **Windows**](https://github.com/dynobo/normcap/releases/download/v0.6.1/NormCap-0.6.1-x86_64-Windows.zip)
...
- [Download for **Linux (AppImage)¹**](https://github.com/dynobo/normcap/releases/download/v0.6.1/NormCap-0.6.1-x86_64.AppImage)
  <small>x86_64, ~90 MB</small>
- [Download for **macOS**](https://github.com/dynobo/normcap/releases/download/v0.6.1/NormCap-0.6.1-x86_64-macOS.dmg)
  <small>x86_64, ~80 MB</small>
- [Download for **macOS (M1)**](https://github.com/dynobo/normcap/releases/download/v0.6.1/NormCap-0.6.1-arm64-macOS.dmg)
