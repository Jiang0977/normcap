...
from normcap.system.info import config_directory, is_portable_windows_package
...
DEFAULT_SETTINGS = (
    ...
    Setting(
        ...
        type_=str,
        value="tesseract",
        help_="Select OCR backend.",
        choices=("tesseract", "baidu"),
        cli_arg=False,
        nargs=None,
    ),
    Setting(
    ...
    Setting(
        ...
        type_=str,
        value="",
        help_="Baidu OCR secret key",
        choices=None,
        cli_arg=False,
        nargs=None,
    ),
    Setting(
        key="baidu-language-type",
        flag="",
        type_=str,
        value="CHN_ENG",
        help_="Baidu OCR language type",
        choices=None,
        cli_arg=False,
        nargs=None,
    ),
